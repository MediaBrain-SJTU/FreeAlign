...
class V2XSIMBaseDataset(Dataset):
        ...
        for i, scene_info in enumerate(self.dataset_info_pkl):
            ...
            for j, cav_id in enumerate(cav_ids):
                if j > self.max_cav - 1:
                    ...
                    break
                self.scene_database[i]["scenario_folder"] = scene_info["scene_id"]
                self.scene_database[i]["timestep"] = scene_info["timestep"]
    ...
    def retrieve_base_data(self, idx):
        ...
        data["scenario_folder"] = scene["scenario_folder"]
        data["timestep"] = scene["timestep"]
