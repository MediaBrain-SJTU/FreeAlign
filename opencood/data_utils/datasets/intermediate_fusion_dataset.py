...
# from freealign.match.match_v9_with_detection import get_pose_rotation
        ...
        def __getitem__(self, idx):
            ...
            if self.box_align and str(idx) in self.stage1_result.keys():
                ...
                if stage1_content is not None:
                    ...
                    cur_agent_pose_list = [base_data_dict[cav_id]['params']['lidar_pose'] for cav_id in cav_id_list]
