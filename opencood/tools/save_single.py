...
def main():
    ...
    #         # box_save_path_root = os.path.join(opt.model_dir, "box")
    #         # if not os.path.exists(box_save_path_root):
    #         #     os.makedirs(box_save_path_root)
    #         # box_save_path_root = os.path.join(box_save_path_root, batch_data['ego']['scenario_folder'][0].split('/')[-2], batch_data['ego']['scenario_folder'][0].split('/')[-1])
    #         # if not os.path.exists(box_save_path_root):
    #         #     os.makedirs(box_save_path_root)
    #         # box_save_path = os.path.join(box_save_path_root, 'box_' + batch_data['ego']['timestep'][0] + '.pt')
    #         # torch.save(infer_result, box_save_path)    
    ...
    #         #     vis_save_path_root = os.path.join(vis_save_path_root, batch_data['ego']['scenario_folder'][0].split('/')[-2], batch_data['ego']['scenario_folder'][0].split('/')[-1])
    #         #     if not os.path.exists(vis_save_path_root):
    #         #         os.makedirs(vis_save_path_root)
    ...
    #         #     vis_save_path = os.path.join(vis_save_path_root, 'bev_' + batch_data['ego']['timestep'][0] + '.png')
    #         #     simple_vis.visualize(infer_result,
    #         #                         batch_data['ego'][
    #         #                             'origin_lidar'][0],
    #         #                         hypes['postprocess']['gt_range'],
